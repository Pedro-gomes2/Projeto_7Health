...
* **tb_usuario:** Gerencia informações de cadastro (nome, email, senha, telefone) e controle de data de criação da conta.
* **tb_produtos:** Contém o catálogo de itens fitness, incluindo descrição, preço e valor calórico.
* **tb_pedido:** Relaciona usuários a produtos, controlando a quantidade, valor total e data da transação.
